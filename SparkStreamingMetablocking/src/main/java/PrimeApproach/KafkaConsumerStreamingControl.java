...
public class KafkaConsumerStreamingControl {
...
//            }
            ...
            if (consumerRecords.count()!=0) {
                ...
                consumerRecords.forEach(record -> {
                    ...
                    try {
                    	EntityProfile entity = new EntityProfile(record.value());
    					bufferedWriter.write(entity.getKey() + "|" + entity.isSource() + "\n");
    				} catch (IOException e) {
    					e.printStackTrace();
    				}
